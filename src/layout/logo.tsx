          ...
          <div className="absolute inset-0 flex items-center justify-center bg-opacity-75">
            <div className="px-4 mx-auto max-w-screen-xl text-center text-white">
              <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl">
                <span className="bg-gradient-to-r from-gray-700 via-blue-400 to-purple-500 text-transparent bg-clip-text">Empowering Innovations with Flow-based</span>
              </h1>
              <h5 className="mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-1xl lg:text-1xl">
                <span className="bg-gradient-to-r from-black via-black to-black text-transparent bg-clip-text">Transforming ideas into reality with cutting-edge technology and strategic investments.</span>
              </h5>
